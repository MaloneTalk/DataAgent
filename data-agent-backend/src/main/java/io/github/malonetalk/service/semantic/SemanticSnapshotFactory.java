...
public interface SemanticSnapshotFactory {
    ...
    ColumnMergeSnapshot requirePhysicalColumnSnapshotOrThrow(
            VisibilityContext visibilityContext, String tableName, String columnName);

    String resolveCanonicalTableName(TableMergeSnapshot snapshot);
}
